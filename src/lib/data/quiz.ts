...
export const quizQuestions: Question[] = [
  ...
  {
    id: "name",
    label: "Commençons par faire connaissance. Comment vous appelez-vous ?",
    type: "text",
  ...
  {
    id: "duration",
    label: "Combien de jours prévoyez-vous de rester sur place ?",
    type: "number",
    placeholder: "Ex: 15",
  },
  {
  ...
  {
    id: "extra_info",
    label: "Une dernière chose à nous préciser pour votre PDF ?",
    type: "text",
    placeholder: "Allergies, passion précise...",
  },
  {
    id: "email",
    label: "Dernière étape : votre email pour recevoir l'itinéraire.",
    type: "text",
